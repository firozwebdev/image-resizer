 ...
 */
export function calculateDimensions(originalWidth, originalHeight, targetWidth, targetHeight, maintainAspectRatio = true) {
    ...
    reader.onload = (e) => {
      ...
      img.onload = () => {
        try {
          ...
          if (format === OUTPUT_FORMATS.JPEG || backgroundColor !== 'transparent') {
